...
public class ConfigurationValidatorTests
{
    ...
    {
        var config = new ProxyConfiguration();
        config.AllowedClients.Add(new AllowedClient { Name = "", IpOrCidr = "192.168.1.1" });
        var result = ConfigurationValidator.Validate(config);
        result.Should().NotBeEmpty();
    ...
    {
        var config = new ProxyConfiguration();
        config.AllowedClients.Add(new AllowedClient { Name = "Client1", IpOrCidr = "192.168.1.1" });
        config.AllowedClients.Add(new AllowedClient { Name = "Client1", IpOrCidr = "192.168.1.2" });
        var result = ConfigurationValidator.Validate(config);
        result.Should().NotBeEmpty();
    ...
    {
        var config = new ProxyConfiguration();
        config.AllowedClients.Add(new AllowedClient { Name = "Client1", IpOrCidr = "invalid" });
        var result = ConfigurationValidator.Validate(config);
        result.Should().NotBeEmpty();
    ...
    {
        var config = new ProxyConfiguration();
        config.AllowedClients.Add(new AllowedClient { Name = "All", IpOrCidr = "0.0.0.0/0" });
        var warnings = ConfigurationValidator.GetWarnings(config);
