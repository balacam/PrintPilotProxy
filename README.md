...
In highly secured environments (like hospitals or financial institutions), print clients often cannot connect directly to the internet or external PrintPilot servers. PrintPilotProxy solves this by acting as a secure intermediary.
...
graph LR
    ...
    Proxy[PrintPilotProxy]
    Cloud[PrintPilot Cloud]
    
    PC1 -->|HTTP/HTTPS| Proxy
    PC2 -->|HTTP/HTTPS| Proxy
    Proxy -->|Forward/Connect| Cloud
```
...
Configure your PrintPilot clients to use the proxy server's IP and port (default 8080).
